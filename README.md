okex
====
[![Go Reference](https://pkg.go.dev/badge/github.com/yahtoo/okex.svg)](https://pkg.go.dev/github.com/yahtoo/okex)
[![GitHub go.mod Go version of a Go module](https://img.shields.io/github/go-mod/go-version/amir-the-h/okex.svg)](https://github.com/yahtoo/okex)
[![GoReportCard example](https://goreportcard.com/badge/github.com/yahtoo/okex)](https://goreportcard.com/report/github.com/yahtoo/okex)
[![GitHub license](https://img.shields.io/github/license/amir-the-h/okex.svg)](https://github.com/yahtoo/okex/blob/main/LICENSE)
[![GitHub release](https://img.shields.io/github/release/amir-the-h/okex.svg)](https://github.com/yahtoo/okex/releases/)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)
[![CI](https://github.com/yahtoo/okex/actions/workflows/main.yml/badge.svg)](https://github.com/yahtoo/okex/actions/workflows/main.yml)
[![CodeQL](https://github.com/yahtoo/okex/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/yahtoo/okex/actions/workflows/codeql-analysis.yml)
[![AutoRelease](https://github.com/yahtoo/okex/actions/workflows/release.yml/badge.svg)](https://github.com/yahtoo/okex/actions/workflows/release.yml)
...
```bash
go get github.com/yahtoo/okex@v1.1.4-alpha
```
...
import (
  ...
  ws_public_requests "github.com/yahtoo/okex/requests/ws/public"
  "log"
)
...
* To receive websocket events you can choose [RawEventChan](/api/ws/client.go#L25)
  ...
  channels. [More info](https://github.com/yahtoo/okex/wiki/Handling-WS-events) 
